...
const AddFriendButton: FC<AddFriendButtonProps> = ({}) => {
    ...
    const addFriend = async (email:string) => {
        try {
            ...
            await axios.post('/api/friends/add',{email:validateEmail.email});
    ...
    return <form className='max-w-sm'>
        <label onSubmit={handleSubmit(onSubmit)} htmlFor="email" className='block text-sm font-medium  leading-6 text-gray-900'>
